...
<style>
    ...
    .card h2 { font-size: 1.08rem; color: var(--neutral-800); margin: 0; }
    .muted { color: var(--neutral-500); }
    .table-wrap { width: 100%; overflow-x: auto; }
    .log-table { width: 100%; border-collapse: collapse; min-width: 720px; }
    ...
    .empty-state { color: var(--neutral-500); text-align: center; padding: 1.5rem; }
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-brand">
                @if($user->profile_picture_url)
                    <img src="{{ $user->profile_picture_url }}" alt="{{ $user->name }}" class="brand-avatar">
                @else
                    <div class="brand-avatar-placeholder">{{ strtoupper(substr($user->name, 0, 1)) }}</div>
                @endif
                <div class="brand-meta">
                    <span class="brand-text">BuildWise</span>
                    <span class="brand-subtext">{{ $user->name }} • Admin Dashboard</span>
                </div>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('admin.login-logs') }}" class="nav-item active">
    ...
    <main class="main-content">
        <div class="mobile-header">
            <div class="mobile-header-content">
                ...
                <span style="font-weight: 700;">Login Logs</span>
                <div style="width: 40px;"></div>
            </div>
        </div>

        <section class="hero">
            <h1 class="hero-title">Login Logs</h1>
            <p class="hero-subtitle">Review your administrator sign-in history in one dedicated page.</p>
        ...
        <section class="card">
            <div class="card-header">
                <div>
                    ...
                    <p class="muted">Showing up to the latest login records.</p>
                </div>
                <button type="button" class="btn btn-secondary" onclick="printModal('loginLogsPrint', 'Login Logs')">Print</button>
            </div>

            <div class="table-wrap" id="loginLogsPrint">
